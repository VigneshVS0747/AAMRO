...
export class PackageDetailsComponent {
  ...
  AddtoList() {
    if (this.PackageForm.valid) {
      const packageDetail: PackageDetailsComponent = {
  ...
  EditMode() {
    if (this.data.mode == "Edit") {
      this.PackageForm.patchValue({
        joPackageId: this.data.joData.joPackageId,
        jobOrderId: this.data.joData.jobOrderId,
        height: this.data.joData.height,
        length: this.data.joData.length,
        breadth: this.data.joData.breadth,
        cbm: this.data.joData.cbm,
        cbmPerUnit: this.data.joData.cbmPerUnit,
        packWeightKg: this.data.joData.packWeightKg,
        chargePackWtKg: this.data.joData.chargePackWtKg,
        livestatus: this.data.joData.livestatus,
        createdBy: this.data.joData.createdBy,
        createdDate: this.data.joData.createdDate,
        updatedBy: parseInt(this.userId$),
        updatedDate: this.date
      });
      this.PackageForm.controls['packageTypeId'].setValue(this.data.joData);
      this.PackageForm.controls['commodityId'].setValue(this.data.joData);
      this.commodityName = this.data.joData.commodityName;
      this.packageTypeName = this.data.joData.packageTypeName;
      this.commodityId = this.data.joData.commodityId;
      this.packageTypeId = this.data.joData.packageTypeId;
  ...
  ViewMode() {
    ...
    this.PackageForm.patchValue({
      joPackageId: this.data.joData.joPackageId,
      enquiryId: this.data.joData.enquiryId,
      height: this.data.joData.height,
      length: this.data.joData.length,
      breadth: this.data.joData.breadth,
      cbm: this.data.joData.cbm,
  ...
  CommodityEmpty(event: KeyboardEvent): void {
