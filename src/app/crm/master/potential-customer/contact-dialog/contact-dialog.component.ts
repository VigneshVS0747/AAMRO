...
import { PotentialCustomerContact } from '../potential-customer.model';
...
@Component({
  ...
  styleUrls: ['./contact-dialog.component.css', '../../../../ums/ums.styles.css']
})
export class ContactDialogComponent {
  ...
  ngOnInit() {
    ...
    this.EditMode();
    this.potentialCustomerContact = this.data.list;
  ...
  AddtoContactList() {
    ...
    if (this.ContactForm.valid) {
      const contactDetail: PotentialCustomerContact = {
      ...
      this.potentialCustomerContact.forEach(x => {
      ...
      if (this.exists) {
        ...
        if (this.potentialCustomerContact.length == 0) {
