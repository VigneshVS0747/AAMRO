...
import { joAirStatusHistoryModal } from '../../../job-order.modals';
...
@Component({
  selector: 'app-air-status',
  templateUrl: './air-status.component.html',
  styleUrls: ['./air-status.component.css'],
  providers: [
...
export class AirStatusComponent {
  ...
  close(){
    this.AirStatusDailog.close(this.JOAirStatusList)
  }
