...
import { AddressCrudService } from 'src/app/crm/master/address/address-crud.service';
import { AddressType } from 'src/app/Models/crm/master/AddresssType';
import { PotentialVendorAddress } from 'src/app/crm/master/potential-vendor/potential-vendor.model';
...
@Component({
  selector: 'app-potentialvendor-address-dialog',
  templateUrl: './potentialvendor-address-dialog.component.html',
  styleUrls: ['./potentialvendor-address-dialog.component.css', '../../../../../ums/ums.styles.css']
})
export class PotentialvendorAddressDialogComponent {
  ...
  date = new Date;
  editedContact: PotentialVendorAddress[];
  viewMode: boolean;
  userId$: string;
  ...
  constructor(private fb: FormBuilder,
    ...
    public dialogRef: MatDialogRef<PotentialvendorAddressDialogComponent>) {
  ...
  ngOnInit() {
    this.GetUserId();
    this.iniForm();
    this.potentialVendorAddress = this.data.list;
  ...
  AddtoAddressList() {
    ...
    if (this.AddressForm.valid) {
      const AddressDetail: PotentialVendorAddress = {
      ...
      //this.exists = this.potentialVendorAddress.some(item => item.primaryAddress == primary);
      this.potentialVendorAddress.forEach(x => {
      ...
      this.existAddress = this.potentialVendorAddress.some(item => item.addressName == addressName);
