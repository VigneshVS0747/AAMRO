...
@Component({
  selector: 'app-c-contact-dialog',
  templateUrl: './c-contact-dialog.component.html',
  styleUrls: ['./c-contact-dialog.component.css', '../../../../ums/ums.styles.css']
})
export class CContactDialogComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CContactDialogComponent>
  ) {
  ...
  ngOnInit() {
    ...
    this.EditMode();
    this.customerContact = this.data.list;
  }
  GetUserId() {
  ...
  AddtoContactList() {
    ...
    if (this.ContactForm.valid) {
      const contactDetail: CustomerContact = {
      ...
      this.customerContact.forEach(x => {
