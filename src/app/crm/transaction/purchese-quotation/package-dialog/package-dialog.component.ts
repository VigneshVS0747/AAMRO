...
import { PqTransportMode } from '../purchase-quotation.model';

@Component({
  selector: 'app-package-dialog',
  templateUrl: './package-dialog.component.html',
  styleUrls: ['./package-dialog.component.css', '../../../../ums/ums.styles.css']
})
export class PackageDialogComponent {
  ...
  EditMode() {
    if (this.data.mode == "Edit") {
      this.PackageForm.patchValue({
        pqPackageId: this.data.pqData.pqPackageId,
        purchaseQuoteId: this.data.pqData.purchaseQuoteId,
  ...
  ViewMode() {
    ...
    this.PackageForm.patchValue({
      pqPackageId: this.data.pqData.pqPackageId,
      enquiryId: this.data.pqData.enquiryId,
      height: this.data.pqData.height,
      length: this.data.pqData.length,
      breadth: this.data.pqData.breadth,
      cbm: this.data.pqData.cbm,
